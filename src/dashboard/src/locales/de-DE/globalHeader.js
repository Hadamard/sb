export default {
  ...
  'component.globalHeader.notification.empty': 'Du hast alle Benachrichtigungen angesehen.',
  'component.globalHeader.message': 'Nachricht',
  'component.globalHeader.message.empty': 'Du hast alle Nachrichten angesehen.',
  'component.globalHeader.event': 'Ereignis',
  'component.globalHeader.event.empty': 'Du hast alle Ereignisse angesehen.',
